...
locality=WONOSOBO
organization=AJIVPN
organizationalunit=AJIVPN
commonname=0.0.0.0
email=admin@AJIVPN.COM

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/${GitUser}/g/main/password"
...
echo "<pre>Setup By JAGOANNEON</pre>" > /home/vps/public_html/index.html
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/${GitUser}/g/main/squid3.conf"
...
#configurasi sslh
wget -O /etc/default/sslh "https://raw.githubusercontent.com/ajidanang123/g/main/sslh.conf"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/${GitUser}/g/main/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/${GitUser}/g/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
wget https://raw.githubusercontent.com/${GitUser}/g/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
