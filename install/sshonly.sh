...
wget https://raw.githubusercontent.com/${GitUser}/g/main/install/hanyassh.sh && chmod +x hanyassh.sh && screen -S hanyassh.sh ./hanyassh.sh
...
echo " "
echo "=================================-Script AjiVpn-===========================" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "------------------------------------------JAGOANKANDANG------------------------------------------" | tee -a log-install.txt
echo ""
echo " Reboot 10 Sec"
sleep 10
reboot
